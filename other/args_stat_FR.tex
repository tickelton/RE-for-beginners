...
(parce qu'elles utilisent la convention d'appel \IT{stdcall} et qu'il est donc facile de retrouver 
les instructions \INS{RETN X} en utilisant la commande \IT{grep} sur leur code une fois celui-ci 
désassemblé).
