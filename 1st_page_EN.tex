...
An old Thinkpad X100e netbook.
When power adapter connected, during charging, switches between charging/discharging states once in a second.
And beeping.
However, in "sleep" state it's charging OK.
As well as in powered off state.
If charged, when no adapter connected, discharging OK, as usual.
