...
au moins \Tchar et \IT{wchar\_t}.

Donc, std::string est une classe avec \Tchar comme type de base.

Et std::wstring est une classe avec \IT{wchar\_t} comme type de base.
...
Dans \IT{libstdc++-v3\textbackslash{}include\textbackslash{}bits\textbackslash{}basic\_string.h}
