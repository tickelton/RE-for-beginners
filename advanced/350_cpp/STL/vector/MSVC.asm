...
_this$ = -4 ; size = 4
__Pos$ = 8  ; size = 4
?at@?$vector@HV?$allocator@H@std@@@std@@QAEAAHI@Z PROC ; \verb|std::vector<int,std::allocator<int> >::at, COMDAT|
; \_this\$ = ecx
    push ebp
    mov  ebp, esp
    push ecx
...
_main PROC
    ...
    call ?push_back@?$vector@HV?$allocator@H@std@@@std@@QAEX$$QAH@Z ; \verb|std::vector<int,std::allocator<int> >::push_back|
    ...
    add  esp, 8
    lea  ecx, DWORD PTR _c$[ebp]
    call ?_Tidy@?$vector@HV?$allocator@H@std@@@std@@IAEXXZ ; \verb|std::vector<int,std::allocator<int> >::_Tidy|
    xor  eax, eax
    mov  esp, ebp
    pop  ebp
    ret  0
