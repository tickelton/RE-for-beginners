...
References в \Cpp это тоже указатели (\myref{label_pointers}), но их называют \emph{безопасными} (safe), потому что работая с ними, труднее сделать ошибку (C++11 8.3.2). % FIXME link
