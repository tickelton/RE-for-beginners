...
On peut dire que la disposition de la mémoire de la classe \IT{solid\_box} est \IT{unifiée}:

Classe \IT{solid\_box}:
...
est représenté en mémoire comme une classe \IT{unifiée}, qui contient tous les champs
hérités.
