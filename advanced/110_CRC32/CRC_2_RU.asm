...
; EAX=EAX>>8; образовавшиеся \emph{из ниоткуда} биты в результате (биты 24-31) будут заполнены нулями
    shr    eax, 8

; \verb|EAX=EAX^crctab[EDI*4] - выбираем элемент из таблицы crctab[] под номером EDI|
