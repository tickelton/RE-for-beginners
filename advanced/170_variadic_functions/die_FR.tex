\subsection{Cas de la fonction \IT{vprintf()}}
...
Une d'entre elles est \IT{vprintf()}: elle prend une chaîne de format et un pointeur
...
arguments et le passe à la fonction \IT{vprintf()}, et que cette fonction le traite
