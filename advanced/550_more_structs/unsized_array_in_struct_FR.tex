...
Pourquoi: le champ \IT{Name} peut-être court, donc pourquoi le définir avec une sorte
de constante \IT{MAX\_NAME} qui peut être 128, 256 et même plus ?
...
Ceci est connu comme l'\IT{astuce struct}: \url{http://c-faq.com/struct/structhack.html}.
...
\IT{s[1]}, les plus récents permettent de le déclarer comme un tableau de taille
variable:\IT{s[]}.
Ceci est aussi appelé \IT{membre tableau flexible}\footnote{\url{https://en.wikipedia.org/wiki/Flexible_array_member}}
