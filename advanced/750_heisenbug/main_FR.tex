...
Parfois, un tableau (ou tampon) peut déborder à cause d'une \IT{erreur de poteaux et d'intervalles}:
...
% TBT Related example in the book (Angband game): \myref{Angband}.
