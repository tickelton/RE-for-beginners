...
Puisque \IT{f()} commence à énumérer les éléments de la pile à son premier argument,
...
Dans \IT{f()} nous pouvons lire tous les arguments des fonctions et les variables
...
À titre d'exemple, j'ai retravaillé la fonction \IT{f()}:
