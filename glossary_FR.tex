...
{
  name={tail call},
  description={C'est lorsque le compilateur (ou l'interpréteur) transforme la récursion (ce qui est possible: \IT{tail recursion})
...
\newglossaryentry{security cookie}
{
  ...
  description={
  Une valeur aléatoire, différente à chaque exécution. Vous pouvez en lire plus à ce propos ici: \myref{subsec:BO_protection}}
}
...
\newglossaryentry{integral type}
{
  ...
  description=
  {nombre usuel, mais pas un réel. peut être utilisé pour passer des variables de type booléen et des énumérations}
}
...
\newglossaryentry{real number}
{
  name={nombre réel},
  description={
  {nombre qui peut contenir un point. ceci est \Tfloat et \Tdouble en \CCpp}
  }
}
...
\newglossaryentry{word}
{
  name=word,
  description={
  Dans les ordinateurs plus vieux que les PCs, la taille de la mémoire était
...
\newglossaryentry{padding}
{
  name=padding,
  description=
  {\IT{Padding} en anglais signifie rembourrer un oreiller, un matelat, etc. avec quelque chose afin de lui donner la forme désirée.
