...
Aussi, les trois autres instructions ont le \IT{d} en préfixe,
ce qui signifie qu'elles fonctionnent avec des valeurs de type \IT{double}.
...
Etendons cet exemple avec le type \IT{long} :
...
C'est parce que la valeur d'un \IT{long} de 64-bit occupe exactement deux places de 32-bit.
