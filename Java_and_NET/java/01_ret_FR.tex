...
donc il existe une instruction à part qui fait d'un short sur un octet, \GTT{iconst\_0} qui pousse 0.
...
Il existe aussi \GTT{iconst\_m1} qui pousse -1.
...
sont nommés \q{.lit4} (pour des constantes de nombres flottants constants de simples précisions sur 32-bit) et \q{.lit8}
...
L'instruction \INS{ldc2\_w} est aussi utilisée pour charger des nombres à virgule flottante double précision 
