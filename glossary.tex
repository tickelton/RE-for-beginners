...
{
  name=\RU{частное}\EN{quotient}\ESph{}\PTBRph{}\DEph{}\PLph{}\ITAph{}\FR{quotient}\JPN{商},
...
{
  name=\RU{произведение}\EN{product}\ESph{}\PTBRph{}\DE{Produkt}\PLph{}\ITAph{}\FR{produit}\JPN{積},
...
{
  name=\RU{heap}\EN{heap}\FR{tas}\JPN{ヒープ},
...
{
  name=\RU{интегральный тип данных}\EN{integral data type}\ESph{}\PTBRph{}\DEph{}\PLph{}\ITAph{}\JPN{整数型},
...
{
  name=\RU{вещественное число}\EN{real number}\FR{nombre réel}\ESph{}\PTBRph{}\DEph{}\PLph{}\ITAph{}\JPN{実数},
