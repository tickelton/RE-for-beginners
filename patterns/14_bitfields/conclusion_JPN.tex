...
\lstinputlisting[caption=x86,style=customasmx86]{patterns/14_bitfields/TEST_JNZ_JPN.lst}

\lstinputlisting[caption=x86,style=customasmx86]{patterns/14_bitfields/TEST_JZ_JPN.lst}

\lstinputlisting[caption=ARM (\ARMMode),style=customasmARM]{patterns/14_bitfields/TST_BNE_JPN.lst}
