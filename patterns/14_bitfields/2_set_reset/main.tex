...
\RU{Например}\EN{For example}\DEph{}\FR{Par exemple}\JPN{例}:
...
\JPN{\input{patterns/14_bitfields/2_set_reset/x86_JPN}}
...
\JPN{\input{patterns/14_bitfields/2_set_reset/ARM_JPN}}
...
\JPN{\input{patterns/14_bitfields/2_set_reset/MIPS_JPN}}
