...
den Wert von \emph{eos} nach \Reg{0}. 
...
Am Ende der Funktion wird die Differenz zwischen \emph{eos} und \emph{str}
...
Vor dem Anfang des Schleifenkörpers befindet sich \emph{str} stets in \Reg{0} und
\emph{eos} in \Reg{1}.
