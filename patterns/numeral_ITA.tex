...
Se il sistema numerico ha 10 cifre, ha una \IT{radice} (o \IT{base}) di 10.
Il sistema numerico binario ha \IT{radice} 2.

Cose importanti da ricordare:

1) Un \IT{numero} è un numero, mentre una \IT{cifra} è un termine che deriva dai sistemi di scrittura,
