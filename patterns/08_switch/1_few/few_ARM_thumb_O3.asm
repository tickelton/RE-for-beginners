...
.text:000000E2 91 A0        ADR     R0, aSomethingUnkno ; "something unknown\textbackslash{}n"
.text:000000E4 04 E0        B       default_case

.text:000000E6              zero_case: ; CODE XREF: f1+4
.text:000000E6 95 A0        ADR     R0, aZero ; "zero\textbackslash{}n"
.text:000000E8 02 E0        B       default_case

.text:000000EA              one_case: ; CODE XREF: f1+8
.text:000000EA 96 A0        ADR     R0, aOne ; "one\textbackslash{}n"
.text:000000EC 00 E0        B       default_case

.text:000000EE              two_case: ; CODE XREF: f1+C
.text:000000EE 97 A0        ADR     R0, aTwo ; "two\textbackslash{}n"
