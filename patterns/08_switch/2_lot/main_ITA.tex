...
\input{patterns/08_switch/2_lot/lot_x86_ITA}
\input{patterns/08_switch/2_lot/lot_ARM_ITA}
\input{patterns/08_switch/2_lot/lot_MIPS_ITA}
...
\lstinputlisting[caption=x86,style=customasmx86]{patterns/08_switch/2_lot/skel1_ITA.lst}
