...
次の命令\INS{BLT}（\IT{Branch Less Than}）は、 $i$ が10未満の場合にジャンプします。
...
\myindex{Inline code}
だから、LLVMはループを\IT{展開}しただけでなく、
私の非常に単純な関数 \ttf を\IT{インライン}化し、
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1,style=customasmARM]{patterns/09_loops/simple/ARM/ARM64_GCC491_O3_JPN.s}

\myparagraph{ARM64: \NonOptimizing GCC 4.9.1}

\lstinputlisting[caption=\NonOptimizing GCC 4.9.1 -fno-inline,style=customasmARM]{patterns/09_loops/simple/ARM/ARM64_GCC491_O3_JPN.s}
