...
\JPN{\CCpp 構造体はいくつかの前提があり、単なる変数の集合であり、
...
\JPN{\input{patterns/15_structs/1_systemtime/main_JPN.tex}}
...
\JPN{\input{patterns/15_structs/2_using_malloc/main_JPN.tex}}
...
\JPN{\input{patterns/15_structs/4_packing/main_JPN.tex}}
...
\JPN{\input{patterns/15_structs/5_nested/main_JPN.tex}}
