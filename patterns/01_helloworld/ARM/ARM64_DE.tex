...
Die \TT{STP}-Anweisung (\emph{Store Pair}) speichert zwei Register auf dem Stack gleichzeitig:
\RegX{29} und \RegX{30}.
...
\INS{LDP} (\emph{Load Pair}) stellt anschließend die Register \RegX{29} und \RegX{30} wieder her.
...
Diese arbeitet wie \TT{BX LR}, jedoch wird ein spezielles \emph{Hinweis-}Bit hinzugefügt, welches die \ac{CPU}
