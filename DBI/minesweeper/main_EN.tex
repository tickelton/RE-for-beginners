...
Let's now try to replace rand() function with our version, let it always return zero: \url{https://github.com/DennisYurichev/yurichev.com/blob/master/blog/minesweeper_PIN/minesweeper2.cpp}.
